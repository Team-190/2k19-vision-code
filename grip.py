...
class GripPipeline:
    ...
    def process(self, source0):
        ...
        # Step Filter_Lines0:
        self.__filter_lines_lines = self.find_lines_output
        (self.filter_lines_output) = self.__filter_lines(self.__filter_lines_lines, self.__filter_lines_min_length,
    ...
    class Line:
        ...
        def __init__(self, x1, y1, x2, y2):
            """
            Sets endpoint values. Point 1 is the leftmost point.
            :param x1:
            :param y1:
            :param x2:
            :param y2:
